function dx = f_FluidFlow_Const_4X_VarD(t,s)
%% Reference trajectory
r = [5 4 10 9]';
rd = [0 0 0 0]';

%% disturbance
d_1 = 5*cos(1*t);    % actual disturbance
d_2 = 4*cos(2*t);    % actual disturbance
d_3 = 3*cos(3*t);    % actual disturbance
d_4 = 2*cos(4*t);    % actual disturbance
d1 = [d_1 d_2 d_3 d_4]';
...
fileID = fopen('exp_const_4XUnVard.txt','a');
